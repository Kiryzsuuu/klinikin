  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      await fetch("/api/patient-auth/forgot-password", {
        ...
        body: JSON.stringify({ medicalRecordNo, clinicSlug: slug }),
      });
      router.push(`/c/${slug}/portal/verify-otp?medicalRecordNo=${encodeURIComponent(medicalRecordNo)}&purpose=PATIENT_RESET_PASSWORD`);
    } finally {
      setLoading(false);
    }
  }
